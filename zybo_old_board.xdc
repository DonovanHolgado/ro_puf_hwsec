...
##Buttons
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { rst_btn }]; #IO_L20N_T3_34 Sch=BTN0
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { trigger_btn }]; #IO_L7P_T1_34 Sch=BTN3

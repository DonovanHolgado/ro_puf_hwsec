...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {gen_ros[*].ro_inst/t1}]
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { done }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { trigger_btn }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
